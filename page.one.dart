            ...
            children: <Widget>[
              ...
              TextField(
                ...
                decoration: InputDecoration(
                    labelText: "velocity value",
                    hintText: "enter the velocity value in m/s",
              ...
              TextField(
                ...
                keyboardType: TextInputType.number,
                decoration: InputDecoration(
                    labelText: "speed of sound",
                    hintText: "enter the value of speed of sound in m/s",
                    labelStyle: TextStyle(
                      color: Colors.black87,
                      fontSize: 25,
                    ),
                        ...
                        setState(() {
                          ...
                          switch (_values) {
                            case "Divide":
                              ...
                              _displayText =
                                  "the machnumber = " + div.toStringAsFixed(0);

                              break;
                            default:
                              _displayText = "only divide required";
                          }
                        });
                      },
                    ),
